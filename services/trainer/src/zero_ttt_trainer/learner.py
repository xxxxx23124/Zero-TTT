...
from zero_ttt_trainer.contracts import CheckpointPayload, LearnerDataIdentity
from zero_ttt_trainer.ema import update_slow_weights
from zero_ttt_trainer.gradients import (
...
class Learner:
    ...
    def _fault(self, reason: str) -> NoReturn:
    ...
    def restore(self, path: str | Path, rng: np.random.Generator | None = None) -> None:
