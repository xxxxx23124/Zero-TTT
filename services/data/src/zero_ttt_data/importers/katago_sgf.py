...
from zero_ttt_dataset.records import (
    ImportEvent,
    TrajectoryRecord,
    stable_game_id,
)

from zero_ttt_data.manifest import ManifestAsset, SourceManifest, sha256_file
...
def _root_text(root: Any, property_name: str, default: str = "") -> str:
