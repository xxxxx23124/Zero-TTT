...
from zero_ttt_dataset.locators import (
    AnnotationLocator,
    SnapshotStatistics,
    SnapshotSummary,
    TrajectoryLocator,
...
def _hash_identity_field(digest: _Digest, value: str) -> None:
...
class SnapshotService:
    ...
    def _hash_build_rows(self, identity: _Digest) -> None:
